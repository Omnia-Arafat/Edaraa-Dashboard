...
import "../../../styles/Update_warehouse.css"
const Update_warehouse = () => {
    ...
    return (
      ...
      <form onSubmit={handleSubmit(onSubmit)} id="Update_warehouse_form">
        ...
        <input type="submit" id="submit-button" value={"Update warehouse"} />
